...
namespace RaqmiSystem.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260903235736_WavePointOfSale")]
    partial class WavePointOfSale
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RaqmiSystem.Domain.Pos.PosOutlet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("outlets", "pos");
                });

            modelBuilder.Entity("RaqmiSystem.Domain.Pos.PosProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("RaqmiSystem.Domain.Pos.PosTable", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("OutletId", "Number")
                        .IsUnique();

                    b.ToTable("tables", "pos");
                });

            modelBuilder.Entity("RaqmiSystem.Domain.Pos.PosTicket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("tickets", "pos");
                });

            modelBuilder.Entity("RaqmiSystem.Domain.Pos.PosTicketLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("RaqmiSystem.Domain.Pos.PosProduct", b =>
                {
                    b.HasOne("RaqmiSystem.Domain.Pos.PosOutlet", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RaqmiSystem.Domain.Pos.PosTicket", b =>
                {
                    ...
                    b.HasOne("RaqmiSystem.Domain.Pos.PosTable", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RaqmiSystem.Domain.Pos.PosTicketLine", b =>
                {
                    b.HasOne("RaqmiSystem.Domain.Pos.PosProduct", null)
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("RaqmiSystem.Domain.Pos.PosTicket", null)
                        .WithMany("Lines")
