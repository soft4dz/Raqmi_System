...
namespace RaqmiSystem.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260905214542_FiscaliteModule")]
    partial class FiscaliteModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RaqmiSystem.Domain.Catalog.Article", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("StockItemCode");

                    b.ToTable("articles", "catalog", t =>
                        {
                            t.HasCheckConstraint("ck_articles_stock_link", "(tracks_stock AND stock_item_code IS NOT NULL) OR (NOT tracks_stock AND stock_item_code IS NULL)");

                            t.HasCheckConstraint("ck_articles_unit_price_non_negative", "CAST(unit_price_excl_vat AS numeric) >= 0");
                        });
                });
            ...
            modelBuilder.Entity("RaqmiSystem.Domain.Documents.RenderedDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("RenderedAt")
                        .HasDatabaseName("ix_rendered_documents_rendered_at");

                    b.HasIndex("Type", "Reference")
                        .IsUnique()
                        .HasDatabaseName("ux_rendered_documents_type_reference");

                    b.ToTable("rendered_documents", "documents", t =>
                        {
                            t.HasCheckConstraint("ck_rendered_documents_sha256", "length(sha256) = 64");

                            t.HasCheckConstraint("ck_rendered_documents_size_bytes", "size_bytes > 0");

                            t.HasCheckConstraint("ck_rendered_documents_type", "type IN ('Invoice')");
                        });
                });

            modelBuilder.Entity("RaqmiSystem.Domain.Fiscalite.FiscalReturn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("Year", "Kind")
                        .IsUnique()
                        .HasDatabaseName("ux_fiscal_returns_year_kind");

                    b.ToTable("fiscal_returns", "fiscalite", t =>
                        {
                            t.HasCheckConstraint("ck_fiscal_return_kind", "kind IN ('Simple','Avancee')");
                        });
                });

            modelBuilder.Entity("RaqmiSystem.Domain.Fiscalite.FiscalReturnLine", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<Guid>("FiscalReturnId")
                        .HasColumnType("uuid")
                        .HasColumnName("fiscal_return_id");
                    ...
                    b.HasIndex("FiscalReturnId")
                        .HasDatabaseName("ix_fiscal_return_lines_fiscal_return_id");

                    b.ToTable("fiscal_return_lines", "fiscalite");
                });

            modelBuilder.Entity("RaqmiSystem.Domain.Fiscalite.SifecConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("DeclarantNif")
                        .HasMaxLength(15)
                        .HasColumnType("character varying(15)")
                        .HasColumnName("declarant_nif");
                    ...
                    b.Property<bool?>("LastConnectionTestSucceeded")
                        .HasColumnType("boolean")
                        .HasColumnName("last_connection_test_succeeded");
                    ...
                    b.ToTable("sifec_config", "fiscalite", t =>
                        {
                            t.HasCheckConstraint("ck_sifec_config_declarant_nif_length", "declarant_nif IS NULL OR length(declarant_nif) = 15");

                            t.HasCheckConstraint("ck_sifec_config_mode", "mode IN ('Sandbox','Production')");

                            t.HasCheckConstraint("ck_sifec_config_singleton", "singleton_key = 'GLOBAL'");
                        });
                });

            modelBuilder.Entity("RaqmiSystem.Domain.Fiscalite.SifecTransmission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("InvoiceId")
                        .HasDatabaseName("ix_sifec_transmissions_invoice_id");
            ...
            modelBuilder.Entity("RaqmiSystem.Domain.Fiscalite.TeleDeclaration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("DgiReference")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("dgi_reference");
                    ...
                    b.Property<Guid>("VatDeclarationId")
                        .HasColumnType("uuid")
                        .HasColumnName("vat_declaration_id");
                    ...
                    b.HasIndex("VatDeclarationId")
                        .HasDatabaseName("ix_tele_declarations_vat_declaration_id");
            ...
            modelBuilder.Entity("RaqmiSystem.Domain.Fiscalite.VatDeclaration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal>("BaseHtVentes")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("base_ht_ventes");
                    ...
                    b.Property<decimal>("CreditAnterieur")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("credit_anterieur");
                    ...
                    b.Property<decimal>("TvaCollectee")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("tva_collectee");

                    b.Property<decimal>("TvaDeductible")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("tva_deductible");
                    ...
                    b.HasIndex("Year", "Month")
                        .IsUnique()
                        .HasDatabaseName("ux_vat_declarations_period");
            ...
            modelBuilder.Entity("RaqmiSystem.Domain.Fiscalite.VatPurchaseRegisterEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal>("BaseHt")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("base_ht");
                    ...
                    b.Property<DateOnly>("PieceDate")
                        .HasColumnType("date")
                        .HasColumnName("piece_date");
                    ...
                    b.Property<string>("SupplierNif")
                        .HasMaxLength(15)
                        .HasColumnType("character varying(15)")
                        .HasColumnName("supplier_nif");
                    ...
                    b.HasIndex("PieceDate")
                        .HasDatabaseName("ix_vat_purchase_register_piece_date");

                    b.HasIndex("PurchaseOrderId")
                        .HasDatabaseName("ix_vat_purchase_register_purchase_order_id");
            ...
            modelBuilder.Entity("RaqmiSystem.Domain.Fiscalite.VatSalesRegisterEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("InvoiceId")
                        .HasDatabaseName("ix_vat_sales_register_invoice_id");

                    b.HasIndex("PieceDate")
                        .HasDatabaseName("ix_vat_sales_register_piece_date");
            ...
            modelBuilder.Entity("RaqmiSystem.Domain.Fiscalite.WithholdingTaxEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal>("MontantRetenu")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("montant_retenu");
                    ...
                    b.HasIndex("Date")
                        .HasDatabaseName("ix_withholding_tax_entries_date");
            ...
            modelBuilder.Entity("RaqmiSystem.Domain.Identity.UserUnitAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("UserId", "HotelUnitCode")
                        .IsUnique();

                    b.ToTable("user_unit_assignments", "security");
                });
                    ...
                    b.ToTable("stock_movements", "inventory", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_stock_movements_kind", "kind IN ('PurchaseEntry', 'Consumption', 'TransferOut', 'TransferIn', 'InventoryAdjustment', 'Sale')");
                    ...
                    b.ToTable("hotel_units", "organization", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_hotel_units_sector", "sector IN ('Hospitality', 'Retail', 'Services', 'Manufacturing', 'Education', 'Health', 'Other')");

                            t.HasCheckConstraint("ck_hotel_units_unit_type", "unit_type IN ('Hotel', 'Residence', 'BeachClub', 'Marina', 'Restaurant', 'Shop', 'Office', 'Warehouse', 'School', 'Clinic', 'Other')");
                        });
                });
            ...
            modelBuilder.Entity("RaqmiSystem.Domain.Revenue.DailyRevenueLine", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<Guid>("DailyRevenueId")
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("DailyRevenueId", "CategoryCode")
                        .IsUnique()
                        .HasDatabaseName("ux_daily_revenue_lines_revenue_category");

                    b.ToTable("daily_revenue_lines", "exploitation", t =>
                        {
                            t.HasCheckConstraint("ck_daily_revenue_lines_amount_non_negative", "CAST(amount AS numeric) >= 0");
                        });
                });

            modelBuilder.Entity("RaqmiSystem.Domain.Revenue.RevenueCategory", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
                    ...
                    b.ToTable("revenue_categories", "exploitation", t =>
                        {
            ...
            modelBuilder.Entity("RaqmiSystem.Domain.Billing.Invoice", b =>
                {
                    b.HasOne("RaqmiSystem.Domain.Treasury.CashReceipt", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RaqmiSystem.Domain.Budgeting.BudgetLine", b =>
                {
                    ...
                    b.HasOne("RaqmiSystem.Domain.Revenue.RevenueCategory", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RaqmiSystem.Domain.Fiscalite.FiscalReturnLine", b =>
                {
                    b.HasOne("RaqmiSystem.Domain.Fiscalite.FiscalReturn", null)
                        .WithMany("Lines")
                        .HasForeignKey("FiscalReturnId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("RaqmiSystem.Domain.Fiscalite.TeleDeclaration", b =>
                {
                    b.HasOne("RaqmiSystem.Domain.Fiscalite.VatDeclaration", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RaqmiSystem.Domain.Revenue.DailyRevenueLine", b =>
                {
                    ...
                    b.HasOne("RaqmiSystem.Domain.Revenue.DailyRevenue", null)
                        .WithMany("Lines")
