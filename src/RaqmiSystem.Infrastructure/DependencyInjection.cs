...
public static class DependencyInjection
{
        ...
        JwtOptions jwtOptions)
    {
        ...
        services.AddScoped<IVatRegisterService, VatRegisterService>();
        ...
        services.AddScoped<IFiscalReturnService, FiscalReturnService>();
        services.AddScoped<ISifecService, SifecService>();
